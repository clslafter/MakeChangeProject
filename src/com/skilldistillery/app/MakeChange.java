...
public class MakeChange {
	...
	private static void makeChange(double price, double amount) {
		...
		System.out.printf("Change due: $%.2f. Return: ", changeAmount);
...
//		System.out.printf("\n $%.2f", changeAmount);
		...
		if ((int) numTens > 1) {
			...
			System.out.print((int) numTens + " ten dollar bill ");
		}
...
//		System.out.printf("\n $%.2f", changeAmount);
		...
		if ((int) numFives > 1) {
			...
			System.out.print((int) numFives + " five dollar bill ");
		}
...
//		System.out.printf("\n $%.2f", changeAmount);
		...
		if ((int) numOnes > 1) {
			System.out.print((int) numOnes + " one dollar bills ");
		} else if ((int) numOnes == 1) {
			System.out.print((int) numOnes + " one dollar bill ");
		}
...
//		 System.out.printf("\n $%.2f", changeAmount);
		 ...
		 double numQuarters = changeAmount / 0.25;
			...
			if ((int) numQuarters > 1) {
				System.out.print ((int) numQuarters + " quarters ");
			} else if ((int) numQuarters == 1) {
				System.out.print((int) numQuarters + " quarter ");
			}
...
//			 System.out.printf("\n $%.2f", changeAmount);
			...
			if ((int) numDimes > 1) {
				System.out.print ((int) numDimes + " dimes ");
			} else if ((int) numDimes == 1) {
				System.out.print((int) numDimes + " dime ");
			}
...
//			 System.out.println("\n" + numNickels);
				...
				if ((int) numNickels > 1) {
					System.out.print ((int) numNickels + " nickels ");
				} else if ((int) numNickels == 1) {
					System.out.print((int) numNickels + " nickel ");
				}
...
//				 System.out.println("\n" + numPennies);
					...
					if ((int) numPennies > 1) {
						System.out.print ((int) numPennies + " pennies. ");
					} else if ((int) numPennies == 1) {
						System.out.print((int) numPennies + " penny. ");
					}
